  ...
  console.log(listings)
    ...
    <div className="">
      ...
      <main className='max-w-6xl mx-auto py-2 px-6'>
        {loadingListings ? ( <p className='text-center animate-pulse text-blue-500'>Loading listings...</p>)
         :
          (<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mx-auto'>
            {listings?.map(listing => (
              <div className='flex flex-col card hover:scale-105 transition-all duration-150 ease-out' key={listing.id}>
                ...
                <MediaRenderer src={listing.asset.image} classNamew-44 />
                </div>
                ...
                <div className='pt-2 space-y-4'>
                  ...
                  <div className={`flex items-center space-x-1
                   justify-end text-xs border w-fit ml-auto p-2
